...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    price: 29,
    desc: "轻量级创作者的首选",
    features: ["2,900 积分", "所有基础模型", "标准排队速度"],
  },
  {
    id: "core",
    name: "主力套餐",
    price: 69,
    desc: "性价比之王，适合日常创作",
    features: ["6,900 积分", "解锁高级模型 (Wan2.6/Pro)", "优先生成队列"],
    highlight: true,
  ...
  },
  {
    ...
    price: 129,
    desc: "为高频重度使用者打造",
    features: ["12,900 积分", "全模型无限制访问", "极速极享队列", "专属客服支持"],
  },
  {
    id: "premium",
    name: "高端套餐",
    price: 199,
    desc: "工作室与商业变现必备",
    features: ["19,900 积分", "最高优先级算力", "支持 API 批量调用", "提供商业授权"],
