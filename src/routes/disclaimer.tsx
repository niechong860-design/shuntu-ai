...
export const Route = createFileRoute("/disclaimer")({
  ...
  head: () => ({
    meta: [
      { title: "用户声明与免责声明 — ShunTu" },
      { name: "description", content: "ShunTu AI 用户声明与免责声明，使用本平台前请仔细阅读。" },
      { property: "og:title", content: "用户声明与免责声明 — ShunTu" },
      { property: "og:description", content: "ShunTu AI 用户声明与免责声明，使用本平台前请仔细阅读。" },
    ],
  }),
});
    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-5 py-10 sm:py-14">
        ...
        <Section title="禁止内容与违规使用声明">
          <p>用户不得利用 ShunTu AI 上传、输入、生成、下载、发布、传播、商用或以其他方式使用任何违法违规、侵权或违反公序良俗的内容，包括但不限于：</p>
